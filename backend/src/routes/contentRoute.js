...
router.post(
  ...
  contentData.answerSheetFileName = uploadedAns.filename;
      ...
      return createResponse(res, StatusCodes.INTERNAL_SERVER_ERROR, error.message || "Failed to create content");
    }
  }
);
...
router.put(
  ...
  async (req, res) => {
    try {
      ...
      return createResponse(res, StatusCodes.INTERNAL_SERVER_ERROR, error.message || "Failed to update content");
    }
  }
);
